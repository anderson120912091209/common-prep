          ...
          <div className="w-full md:w-1/2 text-center md:text-left px-8 md:pl-24 md:pr-16">
            <div className="max-w-md mx-auto md:mx-0">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif leading-tight mb-8">
                the future of
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r dark:from-white/80 dark:to-white/60 from-black/80 to-black/60">
                  college prep.
                </span>
              </h1>
              <div className="text-base md:text-lg font-light dark:text-white/70 text-black/70 leading-relaxed mb-12">
                <p>
                  We leverage{" "}
